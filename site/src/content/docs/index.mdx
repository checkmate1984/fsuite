...
| Tool | Purpose |
|---|---|
| [`fs`](/commands/fs/) | Universal search orchestrator — auto-routes your query to the right tool |
| [`ftree`](/commands/ftree/) | Territory scout — full tree + recon data in one call |
| [`fls`](/commands/fls/) | Structured directory listing with recon mode |
| [`fsearch`](/commands/fsearch/) | File / glob discovery |
| [`fcontent`](/commands/fcontent/) | Bounded content search (token-capped ripgrep) |
| [`fmap`](/commands/fmap/) | Symbol cartography — functions, classes, imports |
| [`fread`](/commands/fread/) | Budgeted reading with symbol & line-range resolution |
| [`fedit`](/commands/fedit/) | Surgical editing (line-range, symbol-scoped, anchor-based) |
| [`fwrite`](/commands/fwrite/) | Atomic file creation |
| [`fbash`](/commands/fbash/) | Token-budgeted shell with classification + session state |
| [`fcase`](/commands/fcase/) | Investigation continuity ledger |
| [`freplay`](/commands/freplay/) | Derivation chain replay |
| [`fprobe`](/commands/fprobe/) | Binary / bundle inspection + patching |
| [`fmetrics`](/commands/fmetrics/) | Telemetry analytics + tool-chain prediction |
...
[Read the full story →](/story/episode-0/)
